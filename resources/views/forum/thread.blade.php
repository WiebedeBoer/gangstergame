...
@if ($postcount >=1)
	...
	@elseif($threaddata->subforum =="cafe")
		<a href="/forum">Forum</a> -> <a href="/forum/cafe">Cafe</a> -> <a href="/forum/{{ $threaddata->thread_id }}">{{ $threaddata->thread_name }}</a>
	...
	@elseif($threaddata->subforum =="city")
		<a href="/forum">Forum</a> -> <a href="/forum/kingdom">City Roleplay</a> -> <a href="/forum/{{ $threaddata->thread_id }}">{{ $threaddata->thread_name }}</a>
	@else
