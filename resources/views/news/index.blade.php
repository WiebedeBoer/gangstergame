                ...
                <div class="card-body">
					...
					<div class="links">
						...
						<a name="general"><h2>General News</h2></a>
							<div class="py-4">
								<h3>In Development, 20th of december 2020</h3>
								<p>Welcome to Gangsters. The game is in alpha development.</p>
							</div>
						</div>
						<div class="py-4">
						<a name="developer"><h2>Developers Log</h2></a>
							<div class="py-4">
								<h3>News, 20th of december  2020</h3>
								<p>Manual and news section added.</p>
							</div>
							<div class="py-4">
								<h3>Registration, 20th of december  2020</h3>
								<p>Registration is complete. You can register for the game in alpha stage.</p>
							</div>
							<div class="py-4">
								<h3>Alpha Development, 20th of december 2020</h3>
